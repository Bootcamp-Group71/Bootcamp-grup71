      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 130 }}>
        ...
        <View style={styles.profileSection}>
          <View style={styles.profileImageContainer}>
            <Image source={require('../assets/profile_icon.png')} style={styles.profileImage} resizeMode="contain" />
          </View>
        ...
        <View style={styles.menuContainer}>
                     {/* Kurslarım */}
           <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/courses')}>
             <Text style={styles.menuText}>Kurslarım</Text>
             <View style={styles.arrowContainer}>
               <Image source={require('../assets/forward_arrow.png')} style={styles.arrowIcon} resizeMode="contain" />
             </View>
           </TouchableOpacity>
